...
function viridis(value){
    ...
    var viridis_data = [[0.267004, 0.004874, 0.329415],
    ...
    if(value>=1) return viridis_data[viridis_data.length-1];
    var lut = Math.floor(value*(viridis_data.length-1))
    var c1 = viridis_data[lut];
    var p = value*viridis_data.length-lut;
    var c2 = viridis_data[lut+1];
